...
const joe = Student('Joe', 100, 'Schomoe');
...
const greeting = (anything) => {
  return `Hi, my name is ${anything.name}`;
};
...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log(scope(joe));

// TODO: Uncomment the following line of code to see the output in the browser console
joe.scopeArrow = () => (joe.name)
console.log(joe.scopeArrow());

// TODO: Write a COMMENT below to answer the following questions.
// 1. What is "this" when joe.scope() is invoked?
// This is refrencing to itself as joe the object.
// 2. What is "this" when joe.scopeArrow() is invoked?
// This is refrencing to itself as joe the obhject
// 3. Explain why "this" is different when an arrow function is used.
// Because arrow function creates generic objects not object for certain type, so when using this it is referring to that function not that type of object