...
function displayPics() {
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: Because let is considered as a block scope, that means in this displayPics realm let is only existing inside that while loop, but var can go outside of the block
  console.log(viewed);
